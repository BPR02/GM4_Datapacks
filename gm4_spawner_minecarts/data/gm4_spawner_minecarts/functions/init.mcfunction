...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4034.469592678415 ~ {CustomName:'"gm4_spawner_minecarts_guide"',Tags:["gm4_guide"],data:{type:"module",id:"spawner_minecarts",page_count:0,line_count:1,module_name:"Spawner Minecarts"}}
