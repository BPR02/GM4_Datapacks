...
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2872.802223089131 ~ {CustomName:'"gm4_mysterious_midnights_guide"',Tags:["gm4_guide"],data:{type:"base",expansions:[],id:"mysterious_midnights",page_count:0,line_count:1,module_name:"Mysterious Midnights"}}
