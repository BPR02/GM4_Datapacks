...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 332.547322425669 ~ {CustomName:'"gm4_apple_trees_guide"',Tags:["gm4_guide"],data:{type:"module",id:"apple_trees",page_count:0,line_count:1,module_name:"Apple Trees"}}
