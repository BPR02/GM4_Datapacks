...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4431.654612246164 ~ {CustomName:'"gm4_undead_players_guide"',Tags:["gm4_guide"],data:{type:"module",id:"undead_players",page_count:0,line_count:1,module_name:"Undead Players"}}
