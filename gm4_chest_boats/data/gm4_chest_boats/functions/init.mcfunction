...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 680.29685567109 ~ {CustomName:'"gm4_chest_boats_guide"',Tags:["gm4_guide"],data:{type:"module",id:"chest_boats",page_count:0,line_count:1,module_name:"Chest Boats"}}
