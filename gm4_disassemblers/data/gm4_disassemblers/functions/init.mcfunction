...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 897.579163823216 ~ {CustomName:'"gm4_disassemblers_guide"',Tags:["gm4_guide"],data:{type:"module",id:"disassemblers",page_count:0,line_count:1,module_name:"Disassemblers"}}
