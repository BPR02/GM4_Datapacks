...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3414.390832451182 ~ {CustomName:'"gm4_potion_swords_guide"',Tags:["gm4_guide"],data:{type:"module",id:"potion_swords",page_count:0,line_count:1,module_name:"Potion Swords"}}
