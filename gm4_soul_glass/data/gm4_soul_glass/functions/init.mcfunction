...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4032.374901627249 ~ {CustomName:'"gm4_soul_glass_guide"',Tags:["gm4_guide"],data:{type:"module",id:"soul_glass",page_count:0,line_count:1,module_name:"Soul Glass"}}
