...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 5068.978168549095 ~ {CustomName:'"gm4_xp_storage_guide"',Tags:["gm4_guide"],data:{type:"module",id:"xp_storage",page_count:0,line_count:1,module_name:"XP Storage"}}
