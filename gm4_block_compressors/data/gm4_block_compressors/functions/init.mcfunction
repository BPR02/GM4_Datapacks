...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 507.561571027715 ~ {CustomName:'"gm4_block_compressors_guide"',Tags:["gm4_guide"],data:{type:"module",id:"block_compressors",page_count:0,line_count:1,module_name:"Block Compressors"}}
