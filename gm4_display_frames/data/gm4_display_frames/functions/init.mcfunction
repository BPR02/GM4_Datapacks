...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 897.733109399926 ~ {CustomName:'"gm4_display_frames_guide"',Tags:["gm4_guide"],data:{type:"module",id:"display_frames",page_count:0,line_count:1,module_name:"Display Frames"}}
