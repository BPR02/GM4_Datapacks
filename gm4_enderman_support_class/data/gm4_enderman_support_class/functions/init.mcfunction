...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1137.403206101032 ~ {CustomName:'"gm4_enderman_support_class_guide"',Tags:["gm4_guide"],data:{type:"module",id:"enderman_support_class",page_count:0,line_count:2,module_name:"Enderman Support Class"}}
