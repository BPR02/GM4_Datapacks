...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 425.13672765259 ~ {CustomName:'"gm4_bat_grenades_guide"',Tags:["gm4_guide"],data:{type:"module",id:"bat_grenades",page_count:0,line_count:1,module_name:"Bat Grenades"}}
