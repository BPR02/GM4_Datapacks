...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4255.539464789339 ~ {CustomName:'"gm4_trapped_signs_guide"',Tags:["gm4_guide"],data:{type:"module",id:"trapped_signs",page_count:0,line_count:1,module_name:"Trapped Signs"}}
