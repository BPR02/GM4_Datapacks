...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4035.407299202457 ~ {CustomName:'"gm4_speed_paths_guide"',Tags:["gm4_guide"],data:{type:"module",id:"speed_paths",page_count:0,line_count:1,module_name:"Speed Paths"}}
