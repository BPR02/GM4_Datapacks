...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1198.826895401271 ~ {CustomName:'"gm4_everstone_guide"',Tags:["gm4_guide"],data:{type:"module",id:"everstone",page_count:0,line_count:1,module_name:"Everstone"}}
