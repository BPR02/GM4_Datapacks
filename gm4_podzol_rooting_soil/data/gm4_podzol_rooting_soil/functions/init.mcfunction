...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3410.049756485277 ~ {CustomName:'"gm4_podzol_rooting_soil_guide"',Tags:["gm4_guide"],data:{type:"module",id:"podzol_rooting_soil",page_count:0,line_count:1,module_name:"Podzol Rooting Soil"}}
