...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4776.242502981829 ~ {CustomName:'"gm4_weighted_armour_guide"',Tags:["gm4_guide"],data:{type:"module",id:"weighted_armour",page_count:0,line_count:1,module_name:"Weighted Armour"}}
