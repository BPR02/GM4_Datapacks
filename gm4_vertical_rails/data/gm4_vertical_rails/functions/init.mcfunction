...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4573.029362839848 ~ {CustomName:'"gm4_vertical_rails_guide"',Tags:["gm4_guide"],data:{type:"module",id:"vertical_rails",page_count:0,line_count:1,module_name:"Vertical Rails"}}
