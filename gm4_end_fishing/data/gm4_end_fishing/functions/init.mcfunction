...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1137.410269380909 ~ {CustomName:'"gm4_end_fishing_guide"',Tags:["gm4_guide"],data:{type:"module",id:"end_fishing",page_count:0,line_count:1,module_name:"End Fishing"}}
