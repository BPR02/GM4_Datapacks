...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 867.159872053633 ~ {CustomName:'"gm4_desire_lines_guide"',Tags:["gm4_guide"],data:{type:"module",id:"desire_lines",page_count:0,line_count:1,module_name:"Desire Lines"}}
