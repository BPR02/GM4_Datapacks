...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1137.145595892059 ~ {CustomName:'"gm4_enchantment_extractors_guide"',Tags:["gm4_guide"],data:{type:"module",id:"enchantment_extractors",page_count:0,line_count:2,module_name:"Enchantment Extractors"}}
