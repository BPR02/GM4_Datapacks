...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3002.561659162328 ~ {CustomName:'"gm4_note_block_interface_guide"',Tags:["gm4_guide"],data:{type:"module",id:"note_block_interface",page_count:0,line_count:1,module_name:"Note Block Interface"}}
