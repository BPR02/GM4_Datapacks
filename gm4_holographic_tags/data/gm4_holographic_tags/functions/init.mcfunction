...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1765.06204984401 ~ {CustomName:'"gm4_holographic_tags_guide"',Tags:["gm4_guide"],data:{type:"module",id:"holographic_tags",page_count:0,line_count:1,module_name:"Holographic Tags"}}
