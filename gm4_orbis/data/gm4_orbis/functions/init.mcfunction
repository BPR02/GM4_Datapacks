...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3226.294099390581 ~ {CustomName:'"gm4_orbis_guide"',Tags:["gm4_guide"],data:{type:"base",expansions:[],id:"orbis",page_count:0,line_count:1,module_name:"Orbis"}}
