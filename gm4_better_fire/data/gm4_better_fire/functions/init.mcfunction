...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 455.770248169734 ~ {CustomName:'"gm4_better_fire_guide"',Tags:["gm4_guide"],data:{type:"module",id:"better_fire",page_count:0,line_count:1,module_name:"Better Fire"}}
