...
# bubbly
execute as @a[gamemode=!spectator,tag=gm4_pneuma_bubbly] at @s anchored eyes unless block ^ ^ ^ water unless block ^ ^ ^ #gm4_orb_of_ankou:water_loggable[waterlogged=true] unless block ^ ^ ^ #gm4_orb_of_ankou:seagrass run effect give @s water_breathing 121 0
