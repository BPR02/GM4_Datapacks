...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3226.351847060538 ~ {CustomName:'"gm4_orb_of_ankou_guide"',Tags:["gm4_guide"],data:{type:"module",id:"orb_of_ankou",page_count:0,line_count:1,module_name:"Orb of Ankou"}}
