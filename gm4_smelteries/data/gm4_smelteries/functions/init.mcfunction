...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4012.609778925561 ~ {CustomName:'"gm4_smelteries_guide"',Tags:["gm4_guide"],data:{type:"module",id:"smelteries",page_count:0,line_count:1,module_name:"Smelteries"}}
