...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4190.524297100331 ~ {CustomName:'"gm4_tinkering_compressors_guide"',Tags:["gm4_guide"],data:{type:"module",id:"tinkering_compressors",page_count:0,line_count:2,module_name:"Tinkering Compressors"}}
