...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3747.715612412508 ~ {CustomName:'"gm4_relocators_guide"',Tags:["gm4_guide"],data:{type:"module",id:"relocators",page_count:0,line_count:1,module_name:"Relocators"}}
