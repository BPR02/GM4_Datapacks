...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 739.663219176003 ~ {CustomName:'"gm4_cozy_campfires_guide"',Tags:["gm4_guide"],data:{type:"module",id:"cozy_campfires",page_count:0,line_count:1,module_name:"Cozy Campfires"}}
