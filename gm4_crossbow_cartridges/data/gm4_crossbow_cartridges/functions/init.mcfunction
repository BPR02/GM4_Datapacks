...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 759.376738885446 ~ {CustomName:'"gm4_crossbow_cartridges_guide"',Tags:["gm4_guide"],data:{type:"module",id:"crossbow_cartridges",page_count:0,line_count:2,module_name:"Crossbow Cartridges"}}
