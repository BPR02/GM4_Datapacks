...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 5426.507494079028 ~ {CustomName:'"gm4_ziprails_guide"',Tags:["gm4_guide"],data:{type:"module",id:"ziprails",page_count:0,line_count:1,module_name:"Ziprails"}}
