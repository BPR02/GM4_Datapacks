...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4076.140283352973 ~ {CustomName:'"gm4_sunken_treasure_guide"',Tags:["gm4_guide"],data:{type:"module",id:"sunken_treasure",page_count:0,line_count:1,module_name:"Sunken Treasure"}}
