...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 451.409887427704 ~ {CustomName:'"gm4_beehive_inspector_guide"',Tags:["gm4_guide"],data:{type:"module",id:"beehive_inspector",page_count:0,line_count:1,module_name:"Beehive Inspector"}}
