...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 530.619456296557 ~ {CustomName:'"gm4_boots_of_ostara_guide"',Tags:["gm4_guide"],data:{type:"module",id:"boots_of_ostara",page_count:0,line_count:1,module_name:"Boots of Ostara"}}
