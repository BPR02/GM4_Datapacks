...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 3365.081694615826 ~ {CustomName:'"gm4_pig_tractors_guide"',Tags:["gm4_guide"],data:{type:"module",id:"pig_tractors",page_count:0,line_count:1,module_name:"Pig Tractors"}}
