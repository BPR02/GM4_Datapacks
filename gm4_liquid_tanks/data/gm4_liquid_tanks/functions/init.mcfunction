...
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2544.348486877165 ~ {CustomName:'"gm4_liquid_tanks_guide"',Tags:["gm4_guide"],data:{type:"base",expansions:[],id:"liquid_tanks",page_count:0,line_count:1,module_name:"Liquid Tanks"}}
