...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4088.792567293057 ~ {CustomName:'"gm4_sweethearts_guide"',Tags:["gm4_guide"],data:{type:"module",id:"sweethearts",page_count:0,line_count:1,module_name:"Sweethearts"}}
