...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 1963.09036415122 ~ {CustomName:'"gm4_ink_spitting_squid_guide"',Tags:["gm4_guide"],data:{type:"module",id:"ink_spitting_squid",page_count:0,line_count:1,module_name:"Ink Spitting Squid"}}
