...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4282.062758194015 ~ {CustomName:'"gm4_tunnel_bores_guide"',Tags:["gm4_guide"],data:{type:"module",id:"tunnel_bores",page_count:0,line_count:1,module_name:"Tunnel Bores"}}
