...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2791.570943633607 ~ {CustomName:'"gm4_mob_conversion_guide"',Tags:["gm4_guide"],data:{type:"module",id:"mob_conversion",page_count:0,line_count:1,module_name:"Mob Conversion"}}
