...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 679.061995077186 ~ {CustomName:'"gm4_chairs_guide"',Tags:["gm4_guide"],data:{type:"module",id:"chairs",page_count:0,line_count:1,module_name:"Chairs"}}
