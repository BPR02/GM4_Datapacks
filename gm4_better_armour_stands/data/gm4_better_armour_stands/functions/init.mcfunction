...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 455.770245686322 ~ {CustomName:'"gm4_better_armour_stands_guide"',Tags:["gm4_guide"],data:{type:"base",expansions:[],id:"better_armour_stands",page_count:0,line_count:2,module_name:"Better Armour Stands"}}
