...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 530.518644900748 ~ {CustomName:'"gm4_book_binders_guide"',Tags:["gm4_guide"],data:{type:"module",id:"book_binders",page_count:0,line_count:1,module_name:"Book Binders"}}
